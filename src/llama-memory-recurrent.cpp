    ...
    if (0 <= seq_id) {
        ...
        if (tail_id >= 0) {
            ...
            if (0 < p0 && p0 <= cell.pos && p1 > cell.pos) {
                ...
                if (pending) {
                    // A pending snapshot must remain intact; clearing its cells
                    // would invalidate the restore that the next decode consumes.
                    return false;
                }
                ...
                // the regular cell clearing loop handles this case correctly.
            }
